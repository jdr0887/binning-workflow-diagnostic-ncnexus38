...
import org.renci.binning.diagnostic.ncnexus38.commons.GenerateReportCallable;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

@Command(scope = "diagnostic-ncnexus38", name = "generate-report", description = "Generate Report")
@Service
    ...
    public Object execute() throws Exception {
        ...
        Executors.newSingleThreadExecutor().execute(() -> {
            ...
            try {
                ...
                Report report = Executors.newSingleThreadExecutor().submit(new GenerateReportCallable(binningDAOBeanService, binningJob))
                        .get();
