...
import org.renci.canvas.binning.diagnostic.ncnexus38.commons.UpdateDiagnosticBinsCallable;
...
@Command(scope = "diagnostic-ncnexus38", name = "update-diagnostic-bins", description = "Update Diagnostic Bins")
@Service
