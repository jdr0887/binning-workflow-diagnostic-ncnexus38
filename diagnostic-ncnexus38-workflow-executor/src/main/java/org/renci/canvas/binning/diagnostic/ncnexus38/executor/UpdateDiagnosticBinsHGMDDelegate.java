...
public class UpdateDiagnosticBinsHGMDDelegate implements JavaDelegate {

    private static final Logger logger = LoggerFactory.getLogger(UpdateDiagnosticBinsHGMDDelegate.class);

    public UpdateDiagnosticBinsHGMDDelegate() {
        super();
    }
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        try {
            ...
            Executors.newSingleThreadExecutor().submit(new UpdateDiagnosticBinsHGMDCallable(daoBean, binningJob)).get();
