...
public class UpdateDiagnosticBinsClinVarDelegate implements JavaDelegate {

    private static final Logger logger = LoggerFactory.getLogger(UpdateDiagnosticBinsClinVarDelegate.class);

    public UpdateDiagnosticBinsClinVarDelegate() {
        super();
    }
    ...
    public void execute(DelegateExecution execution) {
        ...
        try {
            ...
            Executors.newSingleThreadExecutor().submit(new UpdateDiagnosticBinsClinVarCallable(daoBean, binningJob)).get();
